...
@freezed
class ResultPopularMoviesResponse with _$ResultPopularMoviesResponse {
  const factory ResultPopularMoviesResponse({
  ...
  }) = _ResultPopularMoviesResponse;

  factory ResultPopularMoviesResponse.fromJson(Map<String, dynamic> json) =>
      _$ResultPopularMoviesResponseFromJson(json);
}

...
_$UpcomingMoviesResponseImpl _$$UpcomingMoviesResponseImplFromJson(
  ...
  results: (json['results'] as List<dynamic>?)
      ?.map(
        (e) => ResultUpcomingMoviesResponse.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
...
_$ResultUpcomingMoviesResponseImpl _$$ResultUpcomingMoviesResponseImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ResultUpcomingMoviesResponseImplToJson(
  _$ResultUpcomingMoviesResponseImpl instance,
) => <String, dynamic>{
